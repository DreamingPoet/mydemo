...
#include "DesktopPlatformExWindows.h"
...
bool FDesktopPlatformExWindows::OpenFileDialog( const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, uint32 Flags, TArray<FString>& OutFilenames, int32& OutFilterIndex )
{
...
bool FDesktopPlatformExWindows::OpenFileDialog( const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, uint32 Flags, TArray<FString>& OutFilenames)
{
...
bool FDesktopPlatformExWindows::SaveFileDialog(const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, uint32 Flags, TArray<FString>& OutFilenames)
{
...
bool FDesktopPlatformExWindows::OpenDirectoryDialog(const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, FString& OutFolderName)
{
...
bool FDesktopPlatformExWindows::OpenFontDialog(const void* ParentWindowHandle, FString& OutFontName, float& OutHeight, EFontImportFlags& OutFlags)
{	
	FScopedSystemModalMode SystemModalScope;
	...
	{
		UE_LOG(LogDesktopPlatformEx, Warning, TEXT("Error reading results of font dialog."));
	}
...
bool FDesktopPlatformExWindows::FileDialogShared(bool bSave, const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, uint32 Flags, TArray<FString>& OutFilenames, int32& OutFilterIndex)
{
	FScopedSystemModalMode SystemModalScope;
...
bool FDesktopPlatformExWindows::RegisterEngineInstallation(const FString &RootDir, FString &OutIdentifier)
{
	bool bRes = false;
...
void FDesktopPlatformExWindows::EnumerateEngineInstallations(TMap<FString, FString> &OutInstallations)
{
...
bool FDesktopPlatformExWindows::IsSourceDistribution(const FString &RootDir)
{
	...
	return FDesktopPlatformExBase::IsSourceDistribution(RootDir);
}

bool FDesktopPlatformExWindows::VerifyFileAssociations()
{
...
bool FDesktopPlatformExWindows::UpdateFileAssociations()
{
	TIndirectArray<FRegistryRootedKey> Keys;
	GetRequiredRegistrySettings(Keys);
...
bool FDesktopPlatformExWindows::OpenProject(const FString &ProjectFileName)
{
...
bool FDesktopPlatformExWindows::RunUnrealBuildTool(const FText& Description, const FString& RootDir, const FString& Arguments, FFeedbackContext* Warn, int32& OutExitCode)
{
	OutExitCode = 1;
...
bool FDesktopPlatformExWindows::IsUnrealBuildToolRunning()
{
...
FFeedbackContext* FDesktopPlatformExWindows::GetNativeFeedbackContext()
{
	static FWindowsNativeFeedbackContext FeedbackContext;
	return &FeedbackContext;
}

FString FDesktopPlatformExWindows::GetUserTempPath()
{
	return FString(FPlatformProcess::UserTempDir());
}

void FDesktopPlatformExWindows::GetRequiredRegistrySettings(TIndirectArray<FRegistryRootedKey> &RootedKeys)
{
...
int32 FDesktopPlatformExWindows::GetShellIntegrationVersion(const FString &FileName)
{
