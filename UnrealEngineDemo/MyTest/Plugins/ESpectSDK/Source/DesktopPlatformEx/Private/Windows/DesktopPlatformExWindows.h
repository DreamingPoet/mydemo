...
class FDesktopPlatformExWindows : public FDesktopPlatformExBase
{
public:
	// IDesktopPlatformEx Implementation
	...
	using FDesktopPlatformExBase::RunUnrealBuildTool;
...
typedef FDesktopPlatformExWindows FDesktopPlatformEx;
