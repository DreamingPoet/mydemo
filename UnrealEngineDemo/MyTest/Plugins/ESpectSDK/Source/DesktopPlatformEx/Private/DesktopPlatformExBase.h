...
PRAGMA_DISABLE_DEPRECATION_WARNINGS // For FDesktopPlatformExBase::GetSolutionPath() implementation

class FDesktopPlatformExBase : public IDesktopPlatformEx
{
public:
	FDesktopPlatformExBase();
