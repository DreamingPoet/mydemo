...
namespace PlatformInfo
{
	 ...
	 */
	DESKTOPPLATFORMEX_API const FPlatformInfo* FindPlatformInfo(const FName& InPlatformName);
	 ...
	 * @return The platform info if the platform was found, null otherwise
	 */
	DESKTOPPLATFORMEX_API const FPlatformInfo* FindVanillaPlatformInfo(const FName& InPlatformName);

	/**
	 * Get an array of all the platforms we know about
	 * @return The pointer to the start of the platform array
	 */
	DESKTOPPLATFORMEX_API const TArray<FPlatformInfo>& GetPlatformInfoArray();
	 ...
	 */
	DESKTOPPLATFORMEX_API TArray<FVanillaPlatformEntry> BuildPlatformHierarchy(const EPlatformFilter InFilter);
	...
	*/
	DESKTOPPLATFORMEX_API FVanillaPlatformEntry BuildPlatformHierarchy(const FName& InPlatformName, const EPlatformFilter InFilter);
	 ...
	 * @return The pointer to the start of the platform array
	 */
	DESKTOPPLATFORMEX_API void UpdatePlatformSDKStatus(FString InPlatformName, EPlatformSDKStatus InStatus);
	...
	*/
	DESKTOPPLATFORMEX_API void UpdatePlatformDisplayName(FString InPlatformName, FText InDisplayName);
	...
	*/
	DESKTOPPLATFORMEX_API const TArray<FName>& GetAllPlatformGroupNames();
	...
	* @return An array of FNames.
	*/
	DESKTOPPLATFORMEX_API const TArray<FName>& GetAllVanillaPlatformNames();
}
