 ...
 */
class IDesktopPlatformEx
{
public:
	/** Virtual destructor */
	virtual ~IDesktopPlatformEx() {}
	...
	*/
	UE_DEPRECATED(4.24, "The IDesktopPlatformEx::GetSolutionPath() method has been deprecated. Use the ISourceCodeAccessor interface for cross-IDE support instead.")
